    ...
    return (
        <div className="relative w-full h-[120vh]">
              ...
              <div className='w-full absolute flex flex-col items-center gap-4 top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-14'>
                <h1 className='tracking-wider leading-tight text-3xl md:text-5xl text-teal-800 font-semibold'>
                ...
                <div className='bg-white rounded-sm p-4 w-[90%] md:w-[80%] flex mt-5'>
