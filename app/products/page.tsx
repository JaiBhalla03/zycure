...
const page = () => {
    ...
    return (
        <div className='pt-14 md:pt-20 pb-5 md:pb-10 px-4 md:px-20'>
            ...
            <h1 className='text-4xl md:text-6xl font-semibold'>Our products</h1>
            <div className='w-full flex flex-col items-end py-2 md:py-10'>
                ...
                <div className='w-full md:w-1/2 flex gap-1 justify-center md:justify-start items-center group py-4'>
